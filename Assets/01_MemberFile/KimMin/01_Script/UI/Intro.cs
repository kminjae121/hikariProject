...
public class Intro : MonoBehaviour
{
    ...
    public void BlinkTween()
    {
        ...
        glowScreenSeq = DOTween.Sequence()
            ...
            .PrependInterval(5f)
            .JoinCallback(() => SoundManager.Instance.ChangeMainStageVolume("WindowStart2", true, ISOund.VFX))
            ...
            .JoinCallback(() => SoundManager.Instance.ChangeMainStageVolume("WindowShoooooooot", true, ISOund.VFX))
            ...
            .JoinCallback(() => SoundManager.Instance.ChangeMainStageVolume("WindowStart", true,ISOund.VFX))
